...
import { compressFiles } from './upload-form/imageCompressor';
import {
  STAGE_DURATIONS,
  GRADE_TO_CATEGORIES,
  SUBJECT_CATEGORIES,
...
import type { UploadStage, ExamClassification, UploadFormProps } from './upload-form/types';

// Re-export ExamClassification for external use
