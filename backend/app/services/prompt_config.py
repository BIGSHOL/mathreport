...
AI 프롬프트에 매번 전송되던 정적 데이터를 중앙 관리합니다.
학년/과목에 따라 필요한 부분만 선택적으로 포함하여 토큰을 절감합니다.
"""
...
- "중1", "중2", "중3", "중학교" → **중학교 분류표만 사용** ([중1 수학], [중2 수학], [중3 수학])
  - ❌ 절대 금지: [공통수학1], [공통수학2] 등 고등 과목 사용
- "고1", "고2", "고3", "고등학교" → **고등학교 분류표만 사용**
  - ❌ 절대 금지: [중1 수학], [중2 수학] 등 중학교 과목 사용
...
DIFFICULTY_SYSTEM_4LEVEL = """🚨 **4단계 난이도 시스템 (엄격 적용)**:
...
# ============================================================
# 서술형 채점 가이드 (commentary_agent, exam_prep_strategy_agent 공유)
# ============================================================
...
# ============================================================
# 수준별 학습 전략 (exam_prep_strategy_agent 공유)
# ============================================================
...
# ============================================================
# 상세 서술형 분석 가이드 (prompt_builder 전용, 더 상세한 버전)
# ============================================================
