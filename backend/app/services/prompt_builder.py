...
10. difficulty_reason: 난이도 판단 근거 (특히 high일 때 필수, 15자 이내)
    - high: "3개 이상 개념 복합", "5단계 이상 풀이", "창의적 접근 필요", "고배점 증명" 등
    - medium: "2-4단계 풀이", "공식 변형", "개념 연결" 등 (기본값, 애매하면 중으로)
    - low: "1-2단계 해결", "공식 직접 대입", "단순 계산" 등

⚠️ **보수적 난이도 판정**:
- 상(high)은 시험 전체의 10-20%만, 명확히 최고 난이도일 때만 부여
- 애매한 경우 무조건 중(medium)으로 분류
...
10. difficulty_reason: 난이도 판단 근거 (특히 high일 때 필수, 15자 이내)
    - high: "복합 구문 분석", "고난도 추론", "긴 지문+복합 이해", "창의적 해석" 등
